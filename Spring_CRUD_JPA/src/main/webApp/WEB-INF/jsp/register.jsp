...
<%@ page import="com.yao.springD6.domain.Account"%>

<%
	Account actVO = (Account) request.getAttribute("accountVO");
%>
            ...
            <div class="col-4">
                <form  enctype="multipart/form-data" method="post" action="/insert">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="iptAccount" name="accountName" value="<%= (actVO==null)? "" : actVO.getAccountName()%>">
						<p>${accountMsg}</p>
                    </div>
